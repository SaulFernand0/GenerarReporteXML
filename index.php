<?php
    ...
    $resp = mysqli_query($conex, "select * from cliente c join venta v on (c.idcliente = v.idcliente) join detalle d on (d.idventa = v.idventa) join producto p on (p.idproducto = d.idproducto) where c.idcliente = 1 and v.fecha between '2021-05-05' and '2021-05-05' ");
    if($resp){
